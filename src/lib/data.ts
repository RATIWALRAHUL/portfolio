...
export const projects: Project[] = [
  // 1. Gatecode OMS (LIVE PRODUCTION SYSTEM - http://gatecode.net/)
  {
    ...
    thumbnail: "/projects/gatecode/live-website-screenshot.jpg",
    bannerImage: "/projects/gatecode/live-website-screenshot.jpg",
    ...
    galleryImages: [
      { url: "/projects/gatecode/live-website-screenshot.jpg", caption: "Actual desktop browser screenshot of live Gatecode OMS (http://gatecode.net)." },
  ...
  // 3. Gatexpay (LIVE PAYMENT GATEWAY WEBSITE)
  {
    ...
    thumbnail: "/projects/gatexpay/live-website-screenshot.jpg",
    bannerImage: "/projects/gatexpay/live-website-screenshot.jpg",
    ...
    galleryImages: [
      { url: "/projects/gatexpay/live-website-screenshot.jpg", caption: "Actual desktop browser screenshot of live website (https://www.gatexpay.in)." },
  ...
  // 7. Damru By Namo (LIVE WEBSITE & FIGMA PROTOTYPE)
  {
    ...
    thumbnail: "/projects/damru.jpg",
    bannerImage: "/projects/damru.jpg",
    ...
    galleryImages: [
      { url: "/projects/damru.jpg", caption: "Damru By Namo luxury dining storefront and interactive menu explorer on laptop." },
